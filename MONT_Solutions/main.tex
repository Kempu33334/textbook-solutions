...
\end{problem}
Residue is just what is left behind.

\begin{problem}[2.3.2]{}
Show that the number of the classes modulo $n$ is exactly $n$.
\end{problem}
There is a clear bijection between the numbers $0$, $1$, $\dots$, $n-1$ and each residue class.
...
\end{problem}
We know $2^10 = 1024$, so the answer is $4$.

\begin{problem}[2.4.3]{}
Find $1002 \times 560 \pmod{7}$.
\end{problem}
Since $7 \mid 560$, the answer is $0$.
