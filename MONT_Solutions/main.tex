...
We rewrite the sum to be \[x = \sum_{k \ge 0} \binom{n}{2k}2^{n-2k}\sqrt{3}^k = \dfrac{1}{2}\left((2+\sqrt{3})^n+(2-\sqrt{3})^n\right).\] Now, for the first part, it suffices to show 
\end{document}
