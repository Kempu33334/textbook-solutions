...
Solve in integers the equation \[x^2+xy+y^2 = \left(\dfrac{x+y}{3}+1\right)^2.\]
\end{problem}

We claim that the only solutions are $\boxed{(1, -1)}$ and $\boxed{(-1, 1)}$ which clearly work.

Expanding, we find that \[\dfrac{8 x^2}{9} + \dfrac{8 y^2}{9} + \dfrac{7 x y}{9} - \dfrac{2 x}{3} - \dfrac{2 y}{3} - 1 = 0.\] Treating this as a quadratic in $x$, we have that \[\dfrac{8}{9}x^2+\left(\dfrac{7y}{9}-\dfrac{2}{3}\right)x+\dfrac{8y^2}{9}-\dfrac{2y}{3}-1 = 0.\] In order for this to have real solutions, the discriminant must be non-negative, so \[\left(\dfrac{7y}{9}-\dfrac{2}{3}\right)^2-\dfrac{32}{9}\left(\dfrac{8y^2}{9}-\dfrac{2y}{3}-1\right) -\dfrac{1}{9} (23 y^2 - 12 y - 36) \ge 0.\] Solving this, we find that $|y| < 2$. Now, since the equation is symmetric in $x$ and $y$, we also have that $|x| < 2$. Thus, the equation reduces to a manual case check, from which, we discern the solutions $(1, -1)$ and $(-1, 1)$, as required. $\square$
